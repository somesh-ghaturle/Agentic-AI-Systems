...
# tested.
#
# What differs in dev: no retention lock on the archive, no point-in-time recovery, a
# lower spend alert, a shorter approval window, and a single Vector Search replica.
#
# ---------------------------------------------------------------------------
