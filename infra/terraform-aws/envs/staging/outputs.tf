...
output "knowledge_endpoint" {
  description = "Knowledge collection endpoint. VPC-only here, as in prod — if this is unreachable from the retrieve tool, that is the finding staging exists to produce."
