...
module "observability" {
  ...
  # trace log group through this function. Without it the loop-bound and cost filters
  # watch a group the state machine cannot write to and sit at zero, which reads as
  # healthy.
